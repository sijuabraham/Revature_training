...
public class UserDao {
    ...
    public User createUser(User user) throws SQLException {
        ...
        try (Connection con = ConnectionUtility.createConnection()) {
            PreparedStatement pstmt = con.prepareStatement("INSERT INTO juser (username, password, email) VALUES (?, ?, ?)", Statement.RETURN_GENERATED_KEYS);
    ...
    public List<User> getAllUsers() throws SQLException {
        ...
        try (Connection con = ConnectionUtility.createConnection()) {
            ...
            ResultSet rs = stmt.executeQuery("SELECT * FROM juser");
    ...
    public User getUserByUsernameAndPassword(String username, String password) throws SQLException {
        try (Connection con = ConnectionUtility.createConnection()) {
            PreparedStatement pstmt = con.prepareStatement("SELECT * FROM juser WHERE username = ? AND password = ?");
    ...
    public User updateUser(User user) throws SQLException {
        try (Connection con = ConnectionUtility.createConnection()) {
            PreparedStatement pstmt = con.prepareStatement("UPDATE juser SET username=?, password=?, email=? WHERE id=?");
    ...
    public boolean deleteUserById(int id) throws SQLException {
        try (Connection con = ConnectionUtility.createConnection()) {
            PreparedStatement pstmt = con.prepareStatement("DELETE FROM juser WHERE id = ?");
